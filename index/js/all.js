'use strict';
var elements = document.getElementsByClassName('footer__title');
Array.from(elements).forEach(function (e) {
  e.addEventListener('click', function (e) {
    e.target.classList.toggle('footer__title--active');
  });
});
var sliderPrincipal = $('.banner-slider');
sliderPrincipal.length &&
...
benefits.length &&
  benefits.slick({
    ...
    responsive: [
      {
        breakpoint: 1920,
        settings: { dots: !0, slidesToShow: 4, slidesToScroll: 4 },
      },
      {
        breakpoint: 1350,
        settings: { dots: !0, slidesToShow: 3, slidesToScroll: 3 },
      },
      {
        breakpoint: 991,
...
shelf.length &&
  shelf.slick({
    ...
    responsive: [
      ...
      {
        breakpoint: 1200,
        settings: { arrows: !1, dots: !0, slidesToShow: 3, slidesToScroll: 3 },
      },
      {
        breakpoint: 768,
...
var closeButton = document.querySelector('.newsletter-modal__close');
closeButton &&
  closeButton.addEventListener('click', function (e) {
    closeModalNewsletter();
  });
var closeModal = document.querySelector('#subscription');
function _typeof(e) {
  return (_typeof =
...
closeModal &&
  closeModal.addEventListener('click', function (e) {
    'subscription' == e.target.id && closeModalNewsletter();
  }),
  (function (e, t) {
    'object' ===
    ...
    var f = (function (n) {
      ...
      try {
        P.apply((t = q.call(m.childNodes)), m.childNodes),
      ...
      function ae(t, e, n, i) {
        ...
        if (!i && (T(e), (e = e || k), S)) {
          ...
          if (
            ...
            if (((d = t), (u = e), 1 === p && (Y.test(t) || X.test(t)))) {
              for (
                ((u = (ne.test(t) && ge(e.parentNode)) || e) === e &&
                  f.scope) ||
                  ((a = e.getAttribute('id'))
                    ? (a = a.replace(oe, re))
        ...
        return (
          e != k &&
            ...
            (f.scope = de(function (e) {
              return (
                s.appendChild(e).appendChild(k.createElement('div')),
              ...
              ? function (e, t) {
                  ...
                  return (
                    ...
                    (!f.sortDetached && t.compareDocumentPosition(e) === n)
                      ? e == k || (e.ownerDocument == m && y(m, e))
                        ? -1
                        : t == k || (t.ownerDocument == m && y(m, t))
                        ? 1
                        : l
                        ? M(l, e) - M(l, t)
                        : 0
        ...
        return (
          ...
          ce(function (e, t, n, i) {
            var o,
              ...
              p = g ? (y || (e ? f : c || v) ? [] : t) : u;
            if ((g && g(u, p, n, i), v))
              for (o = be(p, l), v(o, [], n, i), r = o.length; r--; )
                (s = o[r]) && (p[l[r]] = !(u[l[r]] = s));
            if (e) {
              if (y || f) {
                if (y) {
              ...
              ((r = (function e(t) {
                for (
                  ...
                  if ((n = b.relative[t[l].type])) u = [me(we(u), n)];
                    ...
                    if (
                      (n = b.filter[t[l].type].apply(null, t[l].matches))[C]
                    ) {
            ...
            for (
              ...
              if (
                ...
                (i = l(
                  ...
                  (ne.test(r[0].type) && ge(t.parentNode)) || t
                ))
              ) {
        ...
        function (i, o) {
          S.fn[i] = function (e, t) {
            ...
            return (
              ...
              1 < this.length &&
                (H[i] || S.uniqueSort(n), N.test(i) && n.reverse()),
              this.pushStack(n)
            );
          };
        }
            ...
            s = {
              ...
              then: function (t, n, i) {
                ...
                return S.Deferred(function (e) {
                  r[0][3].add(c(0, e, w(i) ? i : q, e.notifyWith)),
                    r[1][3].add(c(0, e, w(t) ? t : q)),
    ...
    var R = S.Deferred();
    function W() {
      k.removeEventListener('DOMContentLoaded', W),
    ...
    (S.fn.ready = function (e) {
      ...
      ('loading' !== k.readyState && !k.documentElement.doScroll)
        ...
        : (k.addEventListener('DOMContentLoaded', W),
            ...
            return 'object' === _typeof(n)
              ...
              : F(
                  ...
                  function (e) {
                    var t;
                    return r && void 0 === e
                      ? void 0 !== (t = Q.get(r, n)) || void 0 !== (t = Z(r, n))
                        ? t
                        : void 0
    ...
    function ye(e, t, n, i, o) {
      ...
      for (d.textContent = '', p = 0; (r = u[p++]); )
        if (i && -1 < S.inArray(r, i)) o && o.push(r);
          ...
          ((l = oe(r)), (s = he(d.appendChild(r), 'script')), l && ge(s), n)
        )
    ...
    function Ce(e, o, r) {
      r
        ...
        : void 0 === G.get(e, o) && S.event.add(e, o, xe);
    }
    (S.event = {
      global: {},
      ...
      special: {
        ...
        click: {
          setup: function (e) {
            e = this || e;
            return (
              de.test(e.type) && e.click && A(e, 'input') && Ce(e, 'click', xe),
              !1
            );
          },
          trigger: function (e) {
            e = this || e;
            return (
              de.test(e.type) && e.click && A(e, 'input') && Ce(e, 'click'), !0
            );
          },
          _default: function (e) {
            e = e.target;
    ...
    function He(n, i, o, r) {
      ...
      var e,
        ...
        f = i[0],
        h = w(f);
      if (h || (1 < u && 'string' == typeof f && !m.checkClone && Ae.test(f)))
      ...
      if (
        ...
        for (a = (s = S.map(he(e, 'script'), De)).length; d < u; d++)
          (l = e),
            d !== p &&
        ...
        if (a)
          for (
            c = s[s.length - 1].ownerDocument, S.map(s, Le), d = 0;
            d < a;
            d++
          )
            (l = s[d]),
              pe.test(l.type || '') &&
                ...
                (l.src && 'module' !== (l.type || '').toLowerCase()
                  ...
                  : b(l.textContent.replace(Ee, ''), l, c));
      }
      return n;
    }
    function Oe(e, t, n) {
      for (var i, o = t ? S.filter(t, e) : e, r = 0; null != (i = o[r]); r++)
        n || 1 !== i.nodeType || S.cleanData(he(i)),
          i.parentNode &&
            (n && oe(i) && ge(he(i, 'script')), i.parentNode.removeChild(i));
      return e;
    }
    S.extend({
      ...
      clone: function (e, t, n) {
        ...
        if (
          ...
          for (s = he(d), i = 0, o = (r = he(e)).length; i < o; i++)
            (a = r[i]),
              (l = s[i]),
              (c = void 0),
              'input' === (c = l.nodeName.toLowerCase()) && de.test(a.type)
                ? (l.checked = a.checked)
                : ('input' !== c && 'textarea' !== c) ||
        ...
        if (t)
          if (n)
            for (
              r = r || he(e), s = s || he(d), i = 0, o = r.length;
              i < o;
              i++
            )
              Ne(r[i], s[i]);
        ...
        return (
          0 < (s = he(d, 'script')).length && ge(s, !u && he(e, 'script')), d
        );
      },
    ...
    function Ye() {
      ...
      _e &&
        ...
        ie.appendChild(Fe).appendChild(_e),
    ...
    function st(e, t, n, i, o, r) {
      ...
      for (; s < 4; s += 2)
        'margin' === n && (l += S.css(e, n + ne[s], !0, o)),
          i
            ? ('content' === n && (l -= S.css(e, 'padding' + ne[s], !0, o)),
              'margin' !== n &&
                (l -= S.css(e, 'border' + ne[s] + 'Width', !0, o)))
            : ((l += S.css(e, 'padding' + ne[s], !0, o)),
              'padding' !== n
                ? (l += S.css(e, 'border' + ne[s] + 'Width', !0, o))
                : (a += S.css(e, 'border' + ne[s] + 'Width', !0, o)));
      return (
        !i &&
          0 <= r &&
          (l +=
    ...
    function yt(o, e, t) {
      ...
      for (
        ...
        if ((n = yt.prefilters[i].call(c, o, d, c.opts)))
          return (
            w(n.stop) &&
    ...
    (S.Animation = S.extend(yt, {
      ...
      tweener: function (e, t) {
        for (
          var n, i = 0, o = (e = w(e) ? ((t = e), ['*']) : e.match(P)).length;
          i < o;
          i++
        )
          (n = e[i]),
          ...
          if ((l = !S.isEmptyObject(t)) || !S.isEmptyObject(p))
            ...
            p))
              l ||
                ...
                h && ce([e], !0),
                u.done(function () {
                  for (i in (h || ce([e]), G.remove(e, 'fxshow'), p))
                    S.style(e, i, p[i]);
                })),
                (l = vt(h ? g[i] : 0, i, u)),
                i in g ||
        ...
        toggleClass: function (o, t) {
          ...
          return 'boolean' == typeof t && s
            ...
            ? this.each(function (e) {
                S(this).toggleClass(o.call(this, e, kt(this), t), t);
              })
            : this.each(function () {
                var e, t, n, i;
                if (s)
                  ...
                  (void 0 !== o && 'boolean' !== r) ||
                    ((e = kt(this)) && G.set(this, '__className__', e),
                    this.setAttribute &&
                      this.setAttribute(
                        'class',
                        (!e && !1 !== o && G.get(this, '__className__')) || ''
                      ));
              });
        },
        hasClass: function (e) {
          for (var t, n = 0, i = ' ' + e + ' '; (t = this[n++]); )
            if (1 === t.nodeType && -1 < (' ' + Tt(kt(t)) + ' ').indexOf(i))
              return !0;
          return !1;
        },
      });
    ...
    S.extend(S.event, {
      trigger: function (e, t, n, i) {
        ...
        if (
          ...
          ((e = e[S.expando]
            ? e
            : new S.Event(p, 'object' === _typeof(e) && e)).isTrigger = i
            ? 2
            : 3),
          (e.namespace = f.join('.')),
          ...
          if (!i && !c.noBubble && !g(n)) {
            for (
              s = c.delegateType || p, At.test(s + p) || (h = h.parentNode);
              h;
              h = h.parentNode
            )
              u.push(h), (r = h);
        ...
        S.each({ focus: 'focusin', blur: 'focusout' }, function (n, i) {
          ...
          S.event.special[i] = {
            ...
            teardown: function () {
              ...
              t
                ? G.access(e, i, t)
                : (e.removeEventListener(n, o, !0), G.remove(e, i));
            },
          };
        });
    var Et = T.location,
        ...
        ajax: function (e, t) {
          ...
          function x(e, t, n, i) {
            ...
            p ||
              ...
              (w = void 0),
              f &&
                v.trigger(i ? 'ajaxSuccess' : 'ajaxError', [b, h, i ? o : r]),
              m.fireWith(g, [b, a]),
              f &&
    ...
    S.ajaxSetup({
      ...
      jsonpCallback: function () {
        var e = Qt.pop() || S.expando + '_' + jt.guid++;
        return (this[e] = !0), e;
      },
    }),
      ...
      (S.fn.load = function (e, t, n) {
        var i,
          ...
          a = e.indexOf(' ');
        return (
          -1 < a && ((i = Tt(e.slice(a))), (e = e.slice(0, a))),
          w(t)
            ? ((n = t), (t = void 0))
      ...
      S.each(['top', 'left'], function (e, n) {
        S.cssHooks[n] = Qe(m.pixelPosition, function (e, t) {
          if (t)
            return (t = Ge(e, n)), Be.test(t) ? S(e).position()[n] + 'px' : t;
        });
      }),
    ...
    return (
      (S.noConflict = function (e) {
        return (
          T.$ === S && (T.$ = en), e && T.jQuery === S && (T.jQuery = Zt), S
        );
      }),
    ...
    (i = 0),
      ...
      (s.prototype.changeSlide = function (e, t) {
        ...
        switch (
          ...
          case 'index':
            ...
            o.slideHandler(o.checkNavigable(e), !1, t),
      ...
      (s.prototype.getSlideCount = function () {
        var o,
          ...
          s = -1 * r.swipeLeft + e;
        return !0 === r.options.swipeToSlide
          ? (r.$slideTrack.find('.slick-slide').each(function (e, t) {
              var n = c(t).outerWidth(),
                i = t.offsetLeft;
              if ((!0 !== r.options.centerMode && (i += n / 2), s < i + n))
                return (o = t), !1;
            }),
            ...
            (n.$slides
              ...
              .each(function (e) {
                ...
                c(this).attr({
                  ...
                  -1 !== t &&
                    ((t = 'slick-slide-control' + n.instanceUid + t),
                    c('#' + t).length &&
